...
describe('BancorWriter Test Suite', () => {
  beforeEach(() =>
    mock({
  ...
  it('Should call the BancorWriter function with the "IBANCORNETWORK" option', async () => {
    ...
    const IBancorNetwork = readFileSync(
    ...
    const IContractRegistry = readFileSync(
  ...
  it('Should call the BancorWriter function with the "IBANCORNETWORK" options, omitting the abi', async () => {
  ...
  it('Should call the BancorWriter function with an erroneous input, whilst omitting the npmPack', async () => {
